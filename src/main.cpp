...
// for both bitcoind and winnercoin-qt, to make it harder for attackers to
...
uint256 hashGenesisBlock("0x0000000030a4d57881b0f5d5e5437c9021343b1ba698d0a07232cbc3e75550ef");
...
const string strMessageMagic = "Winnercoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal winnercoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        hashGenesisBlock = uint256("0x0000000030a4d57881b0f5d5e5437c9021343b1ba698d0a07232cbc3e75550ef");
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "winnercoin is the best future fo r all 2014 khaled elkarfai";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1399044886;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 3075355114;
        ...
        assert(block.hashMerkleRoot == uint256("0x3a2314569224a39776f92cf7289f9f7c10d3f52cee52b36178b77affb4d7f080"));
        block.print();
