 ...
 * The Winnercoin Developers 20011-2012
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Winnercoin Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/winnercoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a winnercoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/winnercoin"), tr("&About %1").arg(qApp->applicationName()), this);
    aboutAction->setToolTip(tr("Show information about Winnercoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for winnercoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    openBitcoinAction = new QAction(QIcon(":/icons/winnercoin"), tr("Open &Winnercoin"), this);
    openBitcoinAction->setToolTip(tr("Show the Winnercoin window"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip("Winnercoin client");
    ...
    notificator = new Notificator(tr("winnercoin-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "open winnercoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Winnercoin network", "", count));
}
    ...
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          ...
          "Do you want to pay the fee?").arg(
                BitcoinUnits::formatWithUnit(BitcoinUnits::WNR, nFeeRequired));
