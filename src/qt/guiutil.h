...
/** Static utility functions used by the Winnercoin Qt UI.
 */
class GUIUtil
{
public:
    ...
    // Render winnercoin addresses in monospace font
    ...
    // Parse "winnercoin:" URL into recipient object, return true on succesful parsing
    // See Winnercoin URL definition discussion here: https://bitcointalk.org/index.php?topic=33490.0
